...
public class Bomb : MonoBehaviour
{
    ...
    void Explode()
    {
        ...
        exploded = true;
        //Disables the collider, allowing players to move through and walk in an explosion
        transform.Find("Collider").gameObject.SetActive(false); //3
        //Destroys the bomb after 0.3 seconds, this ensures all explosiosn will spawn before the GameObject is destroyed
